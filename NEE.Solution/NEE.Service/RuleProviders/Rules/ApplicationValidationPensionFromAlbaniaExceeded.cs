...
{
    public class ApplicationValidationPensionFromAlbaniaExceeded : ApplicationValidationRule
    {
        public ApplicationValidationPensionFromAlbaniaExceeded(Application application)
            : base(application, PensionFromAlbaniaExceeded)
        {
            this.RelatedRemark = new Remark(RemarkType.PensionFromAlbaniaExceeded,
                Name,
                Name,
